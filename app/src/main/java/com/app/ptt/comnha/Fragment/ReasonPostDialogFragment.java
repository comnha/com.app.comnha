 ...
 */
public class ReasonPostDialogFragment extends DialogFragment {
    ...
    public ReasonPostDialogFragment() {
            ...
            public void onClick(View v) {
               if(type && edt_giaithich.getText().equals("")&&opt!=3){
                   ...
                   if (opt == 1) {
                       ...
                       String key1 = dbRef.child(getResources().getString(R.string.notification_CODE) + EditPost.getInstance().getPost().getUserId()).push().getKey();
                       ...
                       childUpdates.put(getResources().getString(R.string.notification_CODE) + EditPost.getInstance().getPost().getUserId() + "/" + key1, notificationValue);
                       ...
                       MyLocation location = EditLocal.getInstance().getMyLocation();
                       location.setReported(true);
                       Map<String, Object> local = location.toMap();
                       childUpdates.put(getResources().getString(R.string.locations_CODE) + location.getLocaID(), local);
