...
public class PhotoAlbum_recycler_adapter extends RecyclerView.Adapter<PhotoAlbum_recycler_adapter.Viewholder> {
    ...
    public Viewholder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new Viewholder(LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_rcyler_photoalbum, parent, false));
    }
...
//                    holder.imgv_avatar.setImageURI(uri);
    ...
    public PhotoAlbum_recycler_adapter(ArrayList<Image> photos,
    ...
    public static class Viewholder extends RecyclerView.ViewHolder {
        ...
        public Viewholder(View itemView) {
            super(itemView);
            imgv = (ImageView) itemView.findViewById(R.id.imgv_rv_photalbum);
        }
    }
