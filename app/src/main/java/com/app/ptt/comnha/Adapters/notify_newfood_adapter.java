...
public class notify_newfood_adapter extends BaseAdapter {
    Activity activity;
    List<NewfoodNotify> items;
    ...
    public interface OnItemClickLiestner {
        void onItemClick(NewfoodNotify notify, Activity activity);
    }
    ...
    public interface OnOptionItemClickListener {
        void onDelNotify(NewfoodNotify notify);

        void onBlockUser(NewfoodNotify notify);
    }
    ...
    public void setList(List<NewfoodNotify> list){
        items=new ArrayList<>();
        items=list;
        notifyDataSetChanged();
    }
    public notify_newfood_adapter(Activity activity, List<NewfoodNotify> items) {
    ...
    public View getView(final int position, View convertView, ViewGroup viewGroup) {
        ...
        holder.title.setText(activity.getString(R.string.text_foodname) + ": " + items.get(position).getName());
...
//                popupMenu.inflate(R.popupMenu.menu_item_notify);
                ...
                contents.add(new Pair<Integer, String>
                        (R.string.text_block_addfood,
                                activity.getString(R.string.text_block_addfood)));
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        switch (item.getItemId()) {
                            case R.string.text_delnotify:
                                ...
                                break;
                            case R.string.text_block_addfood:
                                if (onOptionItemClickListener != null) {
