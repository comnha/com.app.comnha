...
public class Notification_rcycler_adapter_admin extends RecyclerView.Adapter<Notification_rcycler_adapter_admin.ViewHolder> {
    ...
    public void onBindViewHolder( final ViewHolder holder,final int position) {
        if (type == 1) {
           ...
           // if (foods.get(position).getTo().equals("admin")) {


            ////LOCATION
//                if (foods.get(position).getType() == 1) {
//                    String text = foods.get(position).getAccount().getUsername() + " đã thêm món " + foods.get(position).getFood().getName() + " vào quán " + foods.get(position).getStore().getName();
//                    holder.txt_noidung.setText(text);
//                }
//                if (foods.get(position).getType() == 2) {
//                    String text = foods.get(position).getAccount().getUsername() + " đã thêm quán ăn:  " + foods.get(position).getStore().getName();
//                    holder.txt_noidung.setText(text);
//                }
//                if (foods.get(position).getType() == 3) {
//                    String text = foods.get(position).getAccount().getUsername() + " đã thêm review vào quán " + foods.get(position).getStore().getName();
//                    holder.txt_noidung.setText(text);
//                }
//                if (foods.get(position).getType() == 4) {
//                    String text = foods.get(position).getAccount().getUsername() +" đã sửa thông tin quán ăn"+ foods.get(position).getStore().getName()+" và đang chờ phê duyệt";
//                    holder.txt_noidung.setText(text);
//                }
//                if (foods.get(position).getType() == 5) {
//                    String text = foods.get(position).getAccount().getUsername() +" đã report quán "+ foods.get(position).getStore().getName()+" với lý do là "+foods.get(position).getReason()+" và đang chờ phê duyệt";
//                    holder.txt_noidung.setText(text);
//                }
//            if (foods.get(position).getType() == 6) {
//                String text = foods.get(position).getAccount().getUsername() +" đã yêu cầu xóa quán "+ foods.get(position).getStore().getName()+" của mình với lý do là "+foods.get(position).getReason()+" và đang chờ phê duyệt";
//                holder.txt_noidung.setText(text);
//            }
            /// POST
            }
//            if (foods.get(position).getType() == 7) {
//                String text = foods.get(position).getAccount().getUsername() +" đã sửa thông tin bài đăng "+ foods.get(position).getPost().getTitle();
//                holder.txt_noidung.setText(text);
//            }
//            if (foods.get(position).getType() == 8) {
//                String text = foods.get(position).getAccount().getUsername() +" đã report bài đăng "+ foods.get(position).getPost().getTitle()+" với lý do là "+foods.get(position).getReason()+" và đang chờ phê duyệt";
//                holder.txt_noidung.setText(text);
//            }
//            if (foods.get(position).getType() == 9) {
//                String text = foods.get(position).getAccount().getUsername() +" đã yêu cầu xóa bài đăng "+ foods.get(position).getPost().getTitle()+" của mình với lý do là "+foods.get(position).getReason()+" và đang chờ phê duyệt";
//                holder.txt_noidung.setText(text);
//            }
...
//            }
        //Food
//        if (foods.get(position).getType() ==11 ){
//            String text = foods.get(position).getAccount().getUsername() +" đã sửa thông tin món ăn "+ foods.get(position).getFood().getName();
//            holder.txt_noidung.setText(text);
//        }
